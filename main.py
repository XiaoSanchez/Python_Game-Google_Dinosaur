...
def load_sprite_sheet(
    ...
    for i in range(0,ny):
        for j in range(0,nx):
            ...
            img.append(image)
    sprite_rect = img[0].get_rect()
    return img,sprite_rect
...
class Cactus(pygame.sprite.Sprite):
    def __init__(self,speed=5,sizex=-1,sizey=-1):
        ...
        self.images,self.rect = load_sprite_sheet('tree.png',3,1,sizex,sizey,-1)
        self.rect.bottom = int(0.98*height)
...
def introscreen():
    ...
    gameStart = False
    callout,callout_rect = load_image('author.png',196,45,-1)
